...
/obj/machinery/shieldgenerator
	...
	New()
		...
		src.display_active = image('icons/obj/machines/meteor_shield.dmi', "on")
		src.display_battery = image('icons/obj/machines/meteor_shield.dmi', "")
		src.display_panel = image('icons/obj/machines/meteor_shield.dmi', "")
		..()
...
/obj/forcefield/meteorshield
	...
	icon = 'icons/obj/machines/meteor_shield.dmi'
	icon_state = "shield"
	var/sound/sound_shieldhit = "sound/effects/shieldhit2.ogg"
